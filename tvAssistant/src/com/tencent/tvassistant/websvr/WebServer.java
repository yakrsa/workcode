...
public class WebServer extends Thread {
	...
	public void run() {
		...
		try {
			Log.i("httpservice", "webServier run");
			// 创建服务器套接字
			...
			// 增加HTTP请求执行器
//			reqistry.register(PREFIX_ACTION+"*", new HttpDelHandler(webRoot));
			reqistry.register("*", new HttpActionHandler(webRoot));
			// 设置HTTP请求执行器
